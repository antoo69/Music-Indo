...
LOG_GROUP_ID = int(getenv("LOG_GROUP_ID", "-1002163044186"))
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/antoo69/Music-IndoF.git",
)
...
GITHUB_REPO = getenv("GITHUB_REPO", "https://github.com/antoo69/Music-IndoB.git")
